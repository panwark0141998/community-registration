async function testApi() {
    try {
        ...
        console.log("Mocked token, calling /api/search?state=allStates&district=allDistricts ...");
        const res = await fetch("http://localhost:3000/api/search?state=allStates&district=allDistricts", {
